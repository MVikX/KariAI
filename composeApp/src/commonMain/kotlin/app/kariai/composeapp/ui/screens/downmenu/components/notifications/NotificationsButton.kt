package app.kariai.composeapp.ui.screens.downmenu.components.notifications
...
fun NotificationsButton () {
    DownMenuBoxContainer(
        ...
        image = MR.images.notifications_icons_menu
    ) {
        Row(
            verticalAlignment = Alignment.CenterVertically
        ) {
            Text(t("down_menu.notification"), style = MaterialTheme.typography.titleMedium)
        }
    }
}